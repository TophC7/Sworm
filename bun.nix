...
}:
{
  ...
  "@git-diff-view/svelte@0.1.3" = fetchurl {
    url = "https://registry.npmjs.org/@git-diff-view/svelte/-/svelte-0.1.3.tgz";
    hash = "sha512-n7TF6RHhANvi7LqkOKQ2pfouKQT2D5jU3YqKTU+t5gDcfmcQUBITveN5yMAZXn+QF8NAAGCbdaV5AKivnQqv8w==";
  };
