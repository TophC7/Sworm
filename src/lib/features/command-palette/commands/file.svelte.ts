...
import { getActiveProject, getProjects } from '$lib/features/projects/state.svelte'
import { closeProject, getActiveProjectId, getOpenProjectIds, openProject } from '$lib/features/workbench/state.svelte'
