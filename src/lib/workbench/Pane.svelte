<script lang="ts">
  import type { Tab, PaneState } from '$lib/workbench/state.svelte'
  import { setFocusedPane, getFocusedPaneSlot } from '$lib/workbench/state.svelte'
  ...
  import PaneTabBar from '$lib/workbench/PaneTabBar.svelte'
  import SurfaceHost from '$lib/workbench/SurfaceHost.svelte'
  import { getSessions, updateSessionInList } from '$lib/stores/sessions.svelte'
  import { refreshGit } from '$lib/stores/git.svelte'
  import { closeLauncherSurface, openLauncherSurface } from '$lib/surfaces/launcher/service.svelte'
