<script lang="ts">
  import Pane from '$lib/workbench/Pane.svelte'
  import { ResizableHandle, ResizablePane, ResizablePaneGroup } from '$lib/components/ui/resizable'
  import type { PaneSlot, PaneState, Tab } from '$lib/workbench/state.svelte'
  import { createPane, getAllTabs, getPanes, getQuadLayout, getSplitMode } from '$lib/workbench/state.svelte'
