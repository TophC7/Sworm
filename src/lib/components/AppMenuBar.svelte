	...
	<MenubarMenu>
		...
		<MenubarContent>
			<MenubarItem onclick={onNewProject}>
				Open Project
				<span class="text-muted text-[0.68rem]">Ctrl+O</span>
			</MenubarItem>

			{#if recentProjects.length > 0}
				<MenubarSub>
					<MenubarSubTrigger
						class="w-full px-3 py-1.5 text-left cursor-pointer rounded-sm text-fg hover:bg-surface focus:bg-surface transition-colors outline-none flex items-center justify-between"
					>
						Open Recent
			...
			{/if}
			<MenubarSeparator />
			<MenubarItem onclick={handleCloseProject} disabled={!hasActiveProject}>
				Close Project
			</MenubarItem>
		</MenubarContent>
	</MenubarMenu>
	...
	<MenubarMenu>
		...
		<MenubarContent>
			...
			<MenubarItem onclick={zoomIn}>
				Zoom In
				<span class="text-muted text-[0.68rem]">Ctrl+=</span>
			</MenubarItem>
			...
			<MenubarItem onclick={zoomReset}>
				Reset Zoom
				<span class="text-muted text-[0.68rem]">Ctrl+0</span>
			</MenubarItem>
		</MenubarContent>
	</MenubarMenu>
	...
	<MenubarMenu>
		...
		<MenubarContent>
			<MenubarItem disabled={true}>
				Tasks
				<span class="text-muted text-[0.68rem] italic">coming soon</span>
			</MenubarItem>
		</MenubarContent>
	</MenubarMenu>
</MenubarRoot>
