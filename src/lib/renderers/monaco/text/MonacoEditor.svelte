<script lang="ts">
  ...
  } from '$lib/renderers/monaco/text/actions.svelte'
  import { attachIndentRainbow, isIndentRainbowEnabled } from '$lib/renderers/monaco/text/indentRainbow.svelte'
  ...
  let indentRainbow: import('$lib/renderers/monaco/text/indentRainbow.svelte').IndentRainbowHandle | null = null
