...
import { ensureMonacoFormatters } from '$lib/renderers/monaco/core/formatters'
import { ensureMonacoLsp } from '$lib/lsp/registry'
import { registerSwormTheme, SWORM_SHIKI_THEME } from '$lib/renderers/monaco/core/monacoTheme'
...
export function initMonaco(monaco: typeof import('monaco-editor')): Promise<void> {
  ...
  initPromise = (async () => {
    ...
    const { registerNixLanguage } = await import('$lib/renderers/monaco/core/languages/nix')
