...
<script lang="ts">
  ...
  import { openCommitSnapshot, openCurrentFileFromDiff, openStashSnapshot } from '$lib/surfaces/diff/service.svelte'
  import MonacoDiffBody from '$lib/renderers/monaco/diff/MonacoDiffBody.svelte'
