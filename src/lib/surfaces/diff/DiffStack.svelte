<script lang="ts">
  ...
  import DiffControls from '$lib/surfaces/diff/DiffControls.svelte'
  import DiffStackFile from '$lib/surfaces/diff/DiffStackFile.svelte'
  import { setDiffScrollContext, type DiffScrollState } from '$lib/renderers/monaco/diff/scrollContext.svelte'
  import { getDiffEditorPool } from '$lib/renderers/monaco/diff/editorPool.svelte'
  import { DiffModelStore } from '$lib/surfaces/diff/diffModels.svelte'
