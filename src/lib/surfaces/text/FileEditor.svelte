<script lang="ts">
  ...
  import MonacoEditor from '$lib/renderers/monaco/text/MonacoEditor.svelte'
  ...
  import { clearTextSurfaceDirty, openTextInFresh, setTextSurfaceDirty } from '$lib/surfaces/text/service.svelte'
  import { renameTextTab } from '$lib/workbench/state.svelte'
